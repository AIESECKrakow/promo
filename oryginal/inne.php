...
echo "<tr><td class=\"data\">".$data1." <span class=\"dzienk\">".$dzien."</span></td></tr>";
 ...
 $ucze = mysql_query("SELECT * FROM `pp_konkurencje` WHERE date='$data' AND type='inne' GROUP BY unibersity")
or die('Strona nie istnieje');
...
$univ = $ucz['unibersity'];
 echo "<tr><td class=\"univ\">".$univ."</td></tr>";
  ...
  $godzin = mysql_query("SELECT * FROM `pp_konkurencje` WHERE date='$data' AND type='inne' AND unibersity='$univ'")
or die('Strona nie istnieje');

...
echo " <input id='nn' name='tress' type='hidden' value='<li class=\"zapisz\">Zapisałeś się na aktywność</li>'> ";
  ...
  function wypisz_z_konkurencji($user_id, $event_id)
{
  ...
  echo " <input id='nn' name='tress' type='hidden' value='<li class=\"wypisz\">Wypisałeś się z konkurencji :(</li>'> ";
...
echo " <input id='nn' name='tress' type='hidden' value='<li class=\"zapisz\">Właśnie otrzymałeś punkty za aktywność :)</li>'> ";
